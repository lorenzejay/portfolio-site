...
const About = () => {
  return (
    <PaddingWrapper className="py-10 flex flex-col-reverse md:flex-row items-center justify-between gap-4 xl:gap-10 lg:min-h-screen">
      ...
      <div className="flex flex-col mb-5 items-start">
        ...
        <p className="text-gray-500 leading-relaxed mt-4 xl:text-lg">
